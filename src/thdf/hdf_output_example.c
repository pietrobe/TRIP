...
/////////////////////////////////////////////////////////////
THDF_field_t *
make_example_output_field_surface(int N_frequencies, const int N_x, const int N_y, const int N_incl, const int N_azimuth)
{
...
main(int argc, char **argv)
{
	...
	{
		if (THDF_write_field_dataset_to_hdf5(output_dset, &output_field[i], output_field[i].index_i,
											 output_field[i].index_j, output_field[i].index_incl,
											 output_field[i].index_azimuth, 1, 1, 1, 1, N_frequencies)
			< 0)
		{
