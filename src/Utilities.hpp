...
inline std::string
format_execution_time_summary(int mpi_size, double start_time, double setup_time, double solve_end_time, double end_time)
{
	std::stringstream ss;
...
// void
// compute_arbitrary_beam(RT_solver &rt_solver, std::shared_ptr<RT_problem> &rt_problem_ptr, Real mu, Real chi,
